...
// Last modified on 2022-08-10 by Justyn Durnford
...
{
	// 
	template <typename T, std::size_t C> class ColumnIterator
	{
		public:
		...
		{
			return ColumnIterator(A._ptr + offset * C);
		}
	...
	template <typename T, std::size_t R, std::size_t C> class FixedMatrix
	{
		...
		constexpr size_type columnCount() const noexcept
		{
			return C;
		}
